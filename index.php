...
<html lang="en" class="no-js">
  <head>
    ...
    <title>Bhavesh Naphade</title>
    <meta name="viewport" content="width=device-width, initial-scale=1, maximum-scale=1" />
    <meta name="description" content="Bhavesh Naphade - Data Science Enthusiast | ML Powered App Developer | Designer" />
    <meta name="keywords" content="bhavesh, naphade, developer, designer, data science, student, india, freelance, cv, resume" />
    <meta name="author" content="Bhavesh Naphade" />
      ...
      <div class="page-content">
          ...
          <header id="site_header" class="header mobile-menu-hide">
            ...
            <div class="social-links">
              <ul>
                <li><a href="https://www.linkedin.com/in/bhaveshnaphade/" target="_blank"><i class="fab fa-linkedin-in"></i></a></li>
                <li><a href="https://github.com/bhaveshnafde" target="_blank"><i class="fab fa-github"></i></a></li>
                <li><a href="https://twitter.com/NaphadeBhavesh" target="_blank"><i class="fab fa-twitter"></i></a></li>
              </ul>
            </div>
            ...
            <div class="copyrights">Made with <span style="color: #e25555;">&hearts;</span> by Bhavesh Naphade.</div>
          </header>
                      ...
                      <div class="col-sm-12 col-md-12 col-lg-12">
                        <div class="title-block">
                          ...
                          <div class="owl-carousel text-rotation">
                            <div class="item">
                              <div class="sp-subtitle">Data Science Enthusiast</div>
                            </div>

                            <div class="item">
                              <div class="sp-subtitle">ML powered App Developer</div>
                            </div>

                            <div class="item">
                              <div class="sp-subtitle">Graphic Designer</div>
                            </div>
                          </div>
                        </div>
                      </div>
                ...
                <div class="section-content">
                  ...
                  <div class="row">
                    <div class="col-xs-12 col-sm-7">
                      <p>I'm a third year undergraduate student at SVVV University pursuing B.Tech. in CSE (Cloud & Mobile Coomputing - IBM). Being a technology-enthusiast, I love to explore new technologies and leverage it to solve real-life problems. I'm driven by the will to create an impact and encourage diversity and inclusion in communities.</p>
                    </div>
                      ...
                      <div class="info-list">
                        <ul>
                          ...
                          <li>
                            ...
                            <span class="value">Indore, Madhya Pradesh</span>
                          </li>

                          <li>
                            <span class="title">e-mail</span>
                            <span class="value">bhaveshnaphade99@gmail.com</span>
                          </li>

                          <li>
                            <span class="title">Phone</span>
                            <span class="value">+91 7746041010</span>
                          </li>
                        </ul>
                      </div>
                    </div>
                      ...
                      <div class="col-inner">
                        <div class="info-list-w-icon">
                          <div class="info-block-w-icon">
                            ...
                            <div class="ci-text">
                              <h4>ML Powered App Developement</h4>
                              <p>Building smarter apps with Machine Learning, ML is especially well-suited for apps that utilize unstructured data such as images and text, or problems with large number of parameters. Most ML models i use are hosted cloud, but lately i have been working with tensorflow lite to explore on-device ml.</p>
                            </div>
                          </div>
                          <div class="info-block-w-icon">
                            <div class="ci-icon">
                              ...
                              <h4>Data Science</h4>
                              <p>I am a Data Science Enthusiast, learning and deploying Data Science Concepts such as Data Analytics, Data Visualization, Machine Learning, Deep Learning, Big Data, Statistics, Probability. I use my findings from Data Science leverage it to solve real-life problems.</p>
                            </div>
                          </div>
                        </div>
                      </div>
                        ...
                        <div class="info-list-w-icon">
                          <div class="info-block-w-icon">
                            ...
                            <div class="ci-text">
                              ...
                              <p>I recently started my competitive programming journey with learning various Data Structures and Algorithms and their implementation in java, i practice problems on GFG, Hackerrank and participate in contests hosted by Codechef and CodeForces.</p>
                            </div>
                          </div>
                          <div class="info-block-w-icon">
                            <div class="ci-icon">
                              ...
                              <h4>Design</h4>
                              <p>I enjoy Designing in general be it Graphic Design, Web Design, VFX or UI, i believe in minimal design, i design and develop compelling products with minimal design and intuitive interface. </p>
                            </div>
                          </div>
                        </div>
                      </div>
                  ...
                  <div class="row">
                    ...
                    <div class="col-xs-12 col-sm-4">
                      <div class="fun-fact gray-default">
                        ...
                        <i class="lnr lnr-star"></i>
                        <h4>Codechef</h4>
                        <span class="fun-fact-block-value">1545</span>
                        <span class="fun-fact-block-text"></span>
                      </div>
                    </div>
                      ...
                      <div class="timeline timeline-second-style clearfix">
                        <div class="timeline-item clearfix">
                          <div class="left-part">
                            ...
                            <span class="item-company"> Shri Vaishnav Vidhyapeeth Vishwavidyalaya</span>
                          </div>
                          <div class="divider"></div>
                          <div class="right-part">
                            <h4 class="item-title">B.Tech. CSE (Cloud & Mobile Computing - IBM)</h4>
                            <p>third year undergraduate student at SVVV university, Indore. Expected year of graduation 2021.</p>
                          </div>
                        </div>
                        ...
                        <div class="timeline-item clearfix">
                          <div class="left-part">
                            ...
                            <span class="item-company">CBSE - SICA SS School</span>
                          </div>
                          <div class="divider"></div>
                          <div class="right-part">
                            <h4 class="item-title">Senior Secondary School Certificate</h4>
                            <p>obtained senior secondary school certificate from SICA SS School affilated to CBSE with 72.4%</p>
                          </div>
                        </div>
                        ...
                        <div class="timeline-item clearfix">
                          ...
                          <div class="right-part">
                            ...
                            <p>obtained High Secondary certificate from SICA SS School affilated to CBSE with 83.6%.</p>
                          </div>
                        </div>
...
-->
                    ...
                    <div class="col-xs-12 col-sm-5">
                      ...
                      <div class="skills-info skills-second-style">
                        ...
                        <div class="skill clearfix">
                          <h4>Python | Numpy | Pandas | Matplotlib</h4>
                        ...
                        <!-- Skill 2 -->
                        <div class="skill clearfix">
                          <h4>Java | Algorithms | Data Structures</h4>
                      ...
                      <div class="skills-info skills-second-style">
                        <!-- Skill 5 -->
                        <div class="skill clearfix">
                          <h4>Presentation | Communication</h4>
                          <div class="skill-value">95%</div>
                        </div>
                        <div class="skill-container skill-1">
                          <div class="skill-percentage"></div>
                  ...
                  <div class="row">
                      ...
                      <div class="certificate-item clearfix">
                        ...
                        <div class="certi-content">
                          <div class="certi-title">
                            <h4>Google Cloud Platform Big Data and Machine Learning Fundamentals</h4>
                          </div>
                          <div class="certi-id">
                            <span>Credential ID: E4ZD4KAM657U</span>
                          </div>
                    ...
                    <div class="col-xs-12 col-sm-6">
                      <div class="certificate-item clearfix">
                        <div class="certi-logo">
                          <img src="img/clients/ibm1.png" alt="logo">
                        </div>
                        ...
                        <div class="certi-content" >
                          ...
                          <div class="certi-id">
                            <span>Credential ID: G62KH4E4TFFR</span>
                          </div>
                          <div class="certi-date">
                    ...
                    <div class="col-xs-12 col-sm-6">
                      <div class="certificate-item clearfix">
                        <div class="certi-logo">
                          <img src="img/clients/ibm2.png" alt="logo">
                        </div>
                        ...
                        <div class="certi-content">
                          ...
                          <div class="certi-id">
                            <span>Credential ID: 8W3X2PGKGBX5</span>
                          </div>
                          <div class="certi-date">
                    ...
                    <div class="col-xs-12 col-sm-6">
                      <div class="certificate-item clearfix">
                        <div class="certi-logo">
                          <img src="img/clients/ibm3.png" alt="logo">
                        </div>
                        ...
                        <div class="certi-content">
                          ...
                          <div class="certi-id">
                            <span>Credential ID: 8QCN9HTCMT8F</span>
                          </div>
                          <div class="certi-date">
                    ...
                    <div class="col-xs-12 col-sm-6">
                      <div class="certificate-item clearfix">
                        <div class="certi-logo">
                          <img src="img/clients/ibm4.png" alt="logo">
                        </div>
                        ...
                        <div class="certi-content">
                          ...
                          <div class="certi-id">
                            <span>Credential ID: DLELCCMSUEGC</span>
                          </div>
                          <div class="certi-date">
                    ...
                    <div class="col-xs-12 col-sm-6">
                      <div class="certificate-item clearfix">
                        <div class="certi-logo">
                          <img src="img/clients/ibm5.png" alt="logo">
                        </div>

                        <div class="certi-content">
                          <div class="certi-title">
                            <h4>Data Science Methodology</h4>
                          </div>
                          <div class="certi-id">
                            <span>Credential ID: TLPKPRPPCHQS</span>
                          </div>
                          <div class="certi-date">
                    ...
                    <div class="col-xs-12 col-sm-6">
                      <div class="certificate-item clearfix">
                        <div class="certi-logo">
                          <img src="img/clients/udemy.png" alt="logo">
                        </div>
                        ...
                        <div class="certi-content">
                          ...
                          <div class="certi-id">
                            <span>Credential ID: UC-8cd1e215-544a-44b0-87f8-d2b1e129bb0e</span>
                          </div>
                          <div class="certi-date">
                      ...
                      <div class="blog-masonry two-columns clearfix">
                        ...
                        <div class="item post-1">
                          <div class="blog-card">
                            <div class="media-block">
                              <div class="category">
                                <a href="#" title="View all posts in Design">Data Science</a>
                              </div>
                            ...
                            <div class="post-info">
                              <div class="post-date">26 Apr 2020</div>
                              <a href="blog-post-1.html">
                                <h4 class="blog-item-title">Whats GCP BigQuery?</h4>
                              </a>
                            </div>
                          </div>
                        </div>
                        ...
                        <div class="item post-2">
                          <div class="blog-card">
                            <div class="media-block">
                              <div class="category">
                                <a href="#" title="View all posts in UI">Big Data</a>
                              </div>
                            ...
                            <div class="post-info">
                              ...
                              <a href="blog-post-2.html">
                                <h4 class="blog-item-title">Whats Big Data?</h4>
                              </a>
                            </div>
                          </div>
                        </div>
                  ...
                  <div class="row">
                    ...
                    <div class="col-xs-12 col-sm-4">
                      ...
                      <div class="lm-info-block gray-default">
                        ...
                        <h4><a href="tel:7746041010">+91 7746041010</a></h4>
                        <span class="lm-info-block-value"></span>
                        <span class="lm-info-block-text"></span>
                      </div>
                      ...
                      <div class="lm-info-block gray-default">
                        ...
                        <h4><a href="mailto:contact@bhaveshnaphade.in">contact@bhaveshnaphade.in</a></h4>
                        <span class="lm-info-block-value"></span>
                        <span class="lm-info-block-text"></span>
                      </div>
